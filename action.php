			...
			while($row=mysqli_fetch_array($run_query)){
				...
				echo "<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading' style='text-align:center;font-size:20px;'>$title</div>
								<div class='panel-heading' style='text-align:center'>RS:$price</div>
								</div>
								<div class='d-grid gap-2'>
								<button pid='$pro_id' class='quicklook btn btn-warning' style='width:100%;background-color:#5C3317;'>Quick look</button>&nbsp;
								<button pid='$pro_id' class='product btn btn-danger' style='display:block; width:100%; margin-bottom:15px;background-color:#1F6357;'>Add to Cart</button>
			...
			$pro_id=$row['product_id'];
				...
				echo "<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading' style='text-align:center;font-size:15px;'>$title</div>
								<div class='panel-heading' style='text-align:center'>Rs.$price</div>
								</div>
								<div class='d-grid gap-2'>
								<button pid='$pro_id' class='quicklook btn btn-warning' style='width:100%;background-color:#5C3317;'>Quick look</button>&nbsp;
